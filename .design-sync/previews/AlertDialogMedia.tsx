...
// Tinted with bg-destructive/10 + text-destructive
export const DestructiveMedia = () => (
  <AlertDialog open>
...
// Media above centred header in size="sm"
export const SmallDialogMedia = () => (
  <AlertDialog open>
    <AlertDialogTrigger render={<Button variant="outline" />}>Confirm dates</AlertDialogTrigger>
