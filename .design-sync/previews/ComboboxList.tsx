...
export const FlatList = () => (
  <Frame label="Property (function child renders each item)">
...
export const GroupedList = () => (
  <Frame label="Destination (function child renders each group)">
...
export const Filtered = () => (
  <Frame label="Property (typed Raja: filters the list)">
    <Combobox items={resorts} defaultInputValue="Raja" open modal={false}>
      <ComboboxInput placeholder="Search a partner property" className="w-80" />
      <ComboboxContent style={still}>
        <ComboboxEmpty>No properties found.</ComboboxEmpty>
        <ComboboxList>
