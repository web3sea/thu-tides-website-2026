...
import { Delete02Icon, Calendar03Icon, Mail01Icon } from '@hugeicons/core-free-icons';
...
export const Small = () => (
  <AlertDialog open>
    <AlertDialogTrigger render={<Button variant="ghost" />}>Subscribe</AlertDialogTrigger>
    <AlertDialogContent size="sm">
      <AlertDialogHeader>
        <AlertDialogMedia>
          <HugeiconsIcon icon={Mail01Icon} strokeWidth={2} />
        </AlertDialogMedia>
        <AlertDialogTitle>Join the location newsletter?</AlertDialogTitle>
        <AlertDialogDescription>One email a month with new dive and coastal destinations.</AlertDialogDescription>
      </AlertDialogHeader>
      <AlertDialogFooter>
        <AlertDialogCancel>No thanks</AlertDialogCancel>
        <AlertDialogAction variant="brand">Subscribe</AlertDialogAction>
      </AlertDialogFooter>
    </AlertDialogContent>
  </AlertDialog>
);
