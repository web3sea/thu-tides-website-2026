...
export const SideRight = () => (
  <Stage>
    <DropdownMenu defaultOpen>
      <DropdownMenuTrigger render={<Button variant="outline" />}>Open to the right</DropdownMenuTrigger>
      <DropdownMenuContent side="right" align="start" className="w-56">
        <DropdownMenuItem>Download originals</DropdownMenuItem>
        <DropdownMenuItem>Share with resort</DropdownMenuItem>
        <DropdownMenuItem>Copy gallery link</DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  </Stage>
);
