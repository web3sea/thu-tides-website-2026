...
export const GhostCancel = () => (
  <AlertDialog open>
    ...
    <AlertDialogContent>
      ...
      <AlertDialogFooter>
        <AlertDialogCancel variant="ghost">Keep gallery</AlertDialogCancel>
...
// size="sm" inside a small dialog
export const SmallCancel = () => (
  <AlertDialog open>
    ...
    <AlertDialogContent size="sm">
      ...
      <AlertDialogFooter>
        <AlertDialogCancel size="sm">Check calendar</AlertDialogCancel>
        <AlertDialogAction variant="brand" size="sm">Confirm</AlertDialogAction>
      </AlertDialogFooter>
    </AlertDialogContent>
  </AlertDialog>
);
