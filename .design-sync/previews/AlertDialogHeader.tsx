...
// Title + description, left-aligned at default size
...
// Media icon occupies the first column, title and description flow beside it
...
// size="sm": header is centred and stacked
export const CentredSmall = () => (
  <AlertDialog open>
