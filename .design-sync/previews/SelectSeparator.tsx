...
export const BetweenItems = () => (
  <Frame label="Service (package separated from single services)">
    <Select items={services} defaultValue="aerial" open modal={false}>
      <SelectTrigger className="w-64">
        <SelectValue />
      </SelectTrigger>
      <SelectContent alignItemWithTrigger={false}>
        <SelectItem value="aerial">Aerial photography</SelectItem>
        <SelectItem value="underwater">Underwater photography</SelectItem>
        <SelectItem value="video">Video production</SelectItem>
        <SelectSeparator />
        <SelectItem value="package">Full content package</SelectItem>
      </SelectContent>
    </Select>
  </Frame>
);
