...
// DropdownMenuContent portals itself
export const ImplicitPortal = () => (
  <Stage>
...
// Wrapping content in DropdownMenuPortal explicitly
    ...
    <DropdownMenu defaultOpen>
      ...
      <DropdownMenuPortal>
        <DropdownMenuContent className="w-60">
          <DropdownMenuItem>Download originals</DropdownMenuItem>
          <DropdownMenuItem>Share with resort</DropdownMenuItem>
          <DropdownMenuSeparator />
          <DropdownMenuItem variant="destructive">Remove gallery</DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenuPortal>
    </DropdownMenu>
  </Stage>
